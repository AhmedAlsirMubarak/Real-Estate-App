            ...
            @auth
                ...
                @if($user->hasRole('manager'))
                    ...
                    <div x-data="{ open: @js($hrActive) }" class="mb-0.5">
                        ...
                        <div x-show="open" x-cloak x-transition class="ms-6 border-s border-white/10 ps-1 space-y-0.5 pb-1">
                            ...
                            <a href="{{ route('manager.contracts.index') }}"
                               class="sidebar-link flex items-center gap-3 px-4 py-2.5 {{ request()->routeIs('manager.contracts.*') ? 'active' : '' }}">
                                <svg class="w-4 h-4 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/></svg>
                                <span class="text-sm font-medium">{{ $tr('العقود', 'Contracts') }}</span>
                            </a>
                        </div>
                    </div>

                    {{-- Finance --}}
                    <div x-data="{ open: @js(request()->routeIs('manager.finance.*') || request()->routeIs('manager.budgets.*') || (request()->routeIs('manager.reports.*') && !request()->routeIs('manager.scheduled-reports.*')) || (request()->routeIs('manager.expenses.*') && request('scope')==='company')) }" class="mb-0.5">
                        <button @click="open = !open"
                                class="sidebar-link w-full flex items-center gap-3 px-4 py-3 hover:bg-blue-800 {{ request()->routeIs('manager.finance.*') || request()->routeIs('manager.budgets.*') || (request()->routeIs('manager.reports.*') && !request()->routeIs('manager.scheduled-reports.*')) || (request()->routeIs('manager.expenses.*') && request('scope')==='company') ? 'active' : '' }}">
                            <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"/></svg>
                            <span class="text-sm font-medium flex-1">{{ $tr('المالية', 'Finance') }}</span>
                            <svg class="w-4 h-4 flex-shrink-0 transition-transform duration-200" :class="open ? 'rotate-180' : ''" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"/></svg>
                        </button>
                        <div x-show="open" x-cloak x-transition class="ms-6 border-s border-white/10 ps-1 space-y-0.5 pb-1">
                            <a href="{{ route('manager.finance.dashboard') }}"
                               class="sidebar-link flex items-center gap-3 px-4 py-2.5 {{ request()->routeIs('manager.finance.*') ? 'active' : '' }}">
                                <svg class="w-4 h-4 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"/></svg>
                                <span class="text-sm font-medium">{{ $tr('لوحة المالية', 'Finance Dashboard') }}</span>
                            </a>
                            <a href="{{ route('manager.budgets.index') }}"
                               class="sidebar-link flex items-center gap-3 px-4 py-2.5 {{ request()->routeIs('manager.budgets.*') ? 'active' : '' }}">
                                <svg class="w-4 h-4 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 6l3 1m0 0l-3 9a5.002 5.002 0 006.001 0M6 7l3 9M6 7l6-2m6 2l3-1m-3 1l-3 9a5.002 5.002 0 006.001 0M18 7l3 9m-3-9l-6-2m0-2v2m0 16V5m0 16H9m3 0h3"/></svg>
                                <span class="text-sm font-medium">{{ $tr('ميزانية الشركة', 'Company Budget') }}</span>
                            </a>
                            <a href="{{ route('manager.reports.index') }}"
                               class="sidebar-link flex items-center gap-3 px-4 py-2.5 {{ request()->routeIs('manager.reports.index') ? 'active' : '' }}">
                                ...
                                <span class="text-sm font-medium">{{ $tr('الإيرادات', 'Revenue') }}</span>
                            </a>
                            <a href="{{ route('manager.expenses.index') }}?scope=company"
                               class="sidebar-link flex items-center gap-3 px-4 py-2.5 {{ request()->routeIs('manager.expenses.*') && request('scope')==='company' ? 'active' : '' }}">
                    ...
                    <a href="{{ route('manager.assets.index') }}"
                       class="sidebar-link flex items-center gap-3 px-4 py-3 hover:bg-blue-800 {{ request()->routeIs('manager.assets.*') ? 'active' : '' }}">
                        ...
                        <span class="text-sm font-medium">{{ $tr('أصول الشركة', 'Company Assets') }}</span>
                    </a>

                    {{-- ===== REAL ESTATE DEVELOPMENT ===== --}}
                    <div class="px-3 mt-4 mb-2">
                        <p class="text-xs text-yellow-400 font-semibold uppercase tracking-wider px-2 mb-1">{{ $tr('التطوير العقاري', 'Real Estate Development') }}</p>
                    </div>
                    <a href="{{ route('manager.development.index') }}"
                       class="sidebar-link flex items-center gap-3 px-4 py-3 hover:bg-blue-800 {{ request()->routeIs('manager.development.*') ? 'active' : '' }}">
                        <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4"/></svg>
                        <span class="text-sm font-medium">{{ $tr('مشاريع التطوير', 'Development Projects') }}</span>
                        @php $devCount = \App\Models\DevelopmentProject::whereNotIn('status', ['completed'])->count(); @endphp
                        @if($devCount > 0)
                        <span class="ms-auto bg-teal-500 text-white text-xs rounded-full w-5 h-5 flex items-center justify-center font-bold flex-shrink-0">{{ $devCount }}</span>
                        @endif
                    </a>
                    ...
                    <a href="{{ route('manager.properties.index') }}?section=management"
                       class="sidebar-link flex items-center gap-3 px-4 py-3 hover:bg-blue-800 {{ request()->routeIs('manager.properties.*') && !request()->routeIs('manager.properties.commissions') && !request()->routeIs('manager.properties.report.*') ? 'active' : '' }}">
                        <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4"/></svg>
                    ...
                    <a href="{{ route('manager.expenses.index') }}?section=management"
                       class="sidebar-link flex items-center gap-3 px-4 py-3 hover:bg-blue-800 {{ request()->routeIs('manager.expenses.*') && request('section') === 'management' ? 'active' : '' }}">
                        <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 9V7a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2m2 4h10a2 2 0 002-2v-6a2 2 0 00-2-2H9a2 2 0 00-2 2v6a2 2 0 002 2zm7-5a2 2 0 11-4 0 2 2 0 014 0z"/></svg>
                        <span class="text-sm font-medium">{{ $tr('المصروفات', 'Expenses') }}</span>
                    </a>
                    <a href="{{ route('manager.properties.commissions') }}"
                       class="sidebar-link flex items-center gap-3 px-4 py-3 hover:bg-blue-800 {{ request()->routeIs('manager.properties.commissions') ? 'active' : '' }}">
                        <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/></svg>
                        <span class="text-sm font-medium">{{ $tr('عمولة الأعمال', 'Business Commission') }}</span>
                    </a>
                    ...
                    <a href="{{ route('manager.external-properties.index') }}"
                       class="sidebar-link flex items-center gap-3 px-4 py-3 hover:bg-blue-800 {{ request()->routeIs('manager.external-properties.*') && !request()->routeIs('manager.external-properties.commissions') ? 'active' : '' }}">
                    ...
                    <a href="{{ route('manager.external-properties.commissions') }}"
                       class="sidebar-link flex items-center gap-3 px-4 py-3 hover:bg-blue-800 {{ request()->routeIs('manager.external-properties.commissions') ? 'active' : '' }}">
                        <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/></svg>
                        <span class="text-sm font-medium">{{ $tr('عمولة الأعمال', 'Business Commission') }}</span>
                    </a>
                    <a href="{{ route('manager.external-properties.report.create') }}"
                       class="sidebar-link flex items-center gap-3 px-4 py-3 hover:bg-blue-800 {{ request()->routeIs('manager.external-properties.report.*') ? 'active' : '' }}">
                        <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 17v-2m3 2v-4m3 4v-6m2 10H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/></svg>
                        <span class="text-sm font-medium">{{ $tr('التقرير الشامل', 'Comprehensive Report') }}</span>
                    </a>
                ...
                @if($user->hasRole('employee'))
                    ...
                    <a href="{{ route('employee.contacts.index') }}"
                       class="sidebar-link flex items-center gap-3 px-4 py-3 hover:bg-blue-800 {{ request()->routeIs('employee.contacts.*') ? 'active' : '' }}">
                        <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"/></svg>
                        <span class="text-sm font-medium flex items-center gap-1.5">
                            {{ $tr('رسائل التواصل', 'Contact Messages') }}
                            @php $empUnread = \App\Models\ContactMessage::where('is_read', false)->count(); @endphp
                            @if($empUnread > 0)
                            <span class="bg-red-500 text-white text-xs rounded-full w-5 h-5 flex items-center justify-center font-bold">{{ $empUnread > 9 ? '9+' : $empUnread }}</span>
                            @endif
                        </span>
                    </a>
                    ...
                    {{-- ===== HOA ===== --}}
                    <div class="px-3 mt-4 mb-2">
                        <p class="text-xs text-green-400 font-semibold uppercase tracking-wider px-2 mb-1">{{ $tr('جمعية الملاك', 'Owners Association') }}</p>
                    </div>

                    {{-- Associations accordion --}}
                    @php $assocActive = request()->routeIs('employee.associations.*'); @endphp
                    <div x-data="{ open: @js($assocActive) }" class="mb-0.5">
                        <button @click="open = !open"
                                class="sidebar-link w-full flex items-center gap-3 px-4 py-3 hover:bg-blue-800 {{ $assocActive ? 'active' : '' }}">
                            <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0z"/></svg>
                            <span class="text-sm font-medium flex-1">{{ $tr('الجمعيات', 'Associations') }}</span>
                            <svg class="w-4 h-4 flex-shrink-0 transition-transform duration-200" :class="open ? 'rotate-180' : ''" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"/></svg>
                        </button>
                        <div x-show="open" x-cloak x-transition class="ms-6 border-s border-white/10 ps-1 space-y-0.5 pb-1">
                            <a href="{{ route('employee.associations.index') }}"
                               class="sidebar-link flex items-center gap-3 px-4 py-2.5 {{ request()->routeIs('employee.associations.index') || request()->routeIs('employee.associations.show') ? 'active' : '' }}">
                                <svg class="w-4 h-4 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6h16M4 10h16M4 14h16M4 18h16"/></svg>
                                <span class="text-sm font-medium">{{ $tr('كل الجمعيات', 'All Associations') }}</span>
                            </a>
                            <a href="{{ route('employee.associations.create') }}"
                               class="sidebar-link flex items-center gap-3 px-4 py-2.5 {{ request()->routeIs('employee.associations.create') ? 'active' : '' }}">
                                <svg class="w-4 h-4 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4"/></svg>
                                <span class="text-sm font-medium">{{ $tr('إضافة جمعية', 'Add Association') }}</span>
                            </a>
                        </div>
                    </div>
                    ...
                    {{-- ===== EXTERNAL PROPERTIES ===== --}}
                    <div class="px-3 mt-4 mb-2">
                        <p class="text-xs text-teal-400 font-semibold uppercase tracking-wider px-2 mb-1">{{ $tr('العقارات الخارجية', 'External Properties') }}</p>
                    </div>

                    {{-- External Properties accordion --}}
                    @php $extActive = request()->routeIs('employee.external-properties.*'); @endphp
                    <div x-data="{ open: @js($extActive) }" class="mb-0.5">
                        <button @click="open = !open"
                                class="sidebar-link w-full flex items-center gap-3 px-4 py-3 hover:bg-blue-800 {{ $extActive ? 'active' : '' }}">
                            <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3.055 11H5a2 2 0 012 2v1a2 2 0 002 2 2 2 0 012 2v2.945M8 3.935V5.5A2.5 2.5 0 0010.5 8h.5a2 2 0 012 2 2 2 0 104 0 2 2 0 012-2h1.064M15 20.488V18a2 2 0 012-2h3.064M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>
                            <span class="text-sm font-medium flex-1">{{ $tr('العقارات الخارجية', 'External Properties') }}</span>
                            <svg class="w-4 h-4 flex-shrink-0 transition-transform duration-200" :class="open ? 'rotate-180' : ''" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"/></svg>
                        </button>
                        <div x-show="open" x-cloak x-transition class="ms-6 border-s border-white/10 ps-1 space-y-0.5 pb-1">
                            <a href="{{ route('employee.external-properties.index') }}"
                               class="sidebar-link flex items-center gap-3 px-4 py-2.5 {{ request()->routeIs('employee.external-properties.index') || request()->routeIs('employee.external-properties.show') ? 'active' : '' }}">
                                <svg class="w-4 h-4 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6h16M4 10h16M4 14h16M4 18h16"/></svg>
                                <span class="text-sm font-medium">{{ $tr('كل العقارات', 'All Properties') }}</span>
                            </a>
                            <a href="{{ route('employee.external-properties.create') }}"
                               class="sidebar-link flex items-center gap-3 px-4 py-2.5 {{ request()->routeIs('employee.external-properties.create') ? 'active' : '' }}">
                                <svg class="w-4 h-4 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4"/></svg>
                                <span class="text-sm font-medium">{{ $tr('إضافة عقار خارجي', 'Add External Property') }}</span>
                            </a>
                        </div>
                    </div>
                @endif
                ...
                @if($user->hasRole('accountant'))
                    ...
                    {{-- ===== FINANCE ===== --}}
                    <div class="px-3 mt-4 mb-2">
                        <p class="text-xs text-yellow-400 font-semibold uppercase tracking-wider px-2 mb-1">{{ $tr('قسم المالية', 'Finance') }}</p>
                    </div>

                    {{-- Finance accordion --}}
                    <div x-data="{ open: @js(request()->routeIs('manager.finance.*') || request()->routeIs('manager.budgets.*') || request()->routeIs('manager.assets.*') || request()->routeIs('manager.expenses.*') || request()->routeIs('manager.salaries.*') || request()->routeIs('accountant.payments.*')) }" class="mb-0.5">
                        <button @click="open = !open"
                                class="sidebar-link w-full flex items-center gap-3 px-4 py-3 hover:bg-blue-800 {{ request()->routeIs('manager.finance.*') || request()->routeIs('manager.budgets.*') || request()->routeIs('manager.assets.*') || request()->routeIs('manager.expenses.*') || request()->routeIs('manager.salaries.*') || request()->routeIs('accountant.payments.*') ? 'active' : '' }}">
                            <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"/></svg>
                            <span class="text-sm font-medium flex-1">{{ $tr('المالية', 'Finance') }}</span>
                            <svg class="w-4 h-4 flex-shrink-0 transition-transform duration-200" :class="open ? 'rotate-180' : ''" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"/></svg>
                        </button>
                        <div x-show="open" x-cloak x-transition class="ms-6 border-s border-white/10 ps-1 space-y-0.5 pb-1">
                            ...
                            <a href="{{ route('manager.assets.index') }}"
                               class="sidebar-link flex items-center gap-3 px-4 py-2.5 {{ request()->routeIs('manager.assets.*') ? 'active' : '' }}">
                            ...
                            <a href="{{ route('accountant.payments.index') }}"
                               class="sidebar-link flex items-center gap-3 px-4 py-2.5 {{ request()->routeIs('accountant.payments.*') ? 'active' : '' }}">
