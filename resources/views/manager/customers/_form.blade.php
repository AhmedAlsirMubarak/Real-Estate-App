...
<div class="grid grid-cols-1 md:grid-cols-2 gap-4">
    ...
    <div>
        ...
        <input type="text" name="name" value="{{ old('name', $c?->name) }}" required
               @class(['w-full border rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-blue-300 focus:border-blue-400 outline-none', 'border-red-400' => $errors->has('name'), 'border-gray-200' => !$errors->has('name')])
    ...
    <div>
        ...
        <input type="text" name="mobile" value="{{ old('mobile', $c?->mobile) }}"
               ...
               @class(['w-full border rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-blue-300 focus:border-blue-400 outline-none', 'border-red-400' => $errors->has('mobile'), 'border-gray-200' => !$errors->has('mobile')])
    ...
    <div>
        ...
        <input type="email" name="email" value="{{ old('email', $c?->email) }}"
               @class(['w-full border rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-blue-300 focus:border-blue-400 outline-none', 'border-red-400' => $errors->has('email'), 'border-gray-200' => !$errors->has('email')])
