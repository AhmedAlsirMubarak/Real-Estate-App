...
@endphp
<x-slot name="title">{{ $tr('استيراد عقارات من Excel', 'Import Properties from Excel') }}</x-slot>
...
<div class="max-w-3xl mx-auto py-4">
    ...
    <a href="{{ route('manager.properties.index') }}"
       class="text-sm text-gray-500 hover:text-gray-700 mb-5 inline-flex items-center gap-1">
        ...
        {{ $tr('رجوع إلى العقارات', 'Back to Properties') }}
    </a>

    {{-- Page title --}}
    <div class="mb-6">
        <h2 class="text-xl font-bold text-gray-800">
            {{ $tr('استيراد عقارات من Excel', 'Import Properties from Excel') }}
        </h2>
        <p class="text-sm text-gray-500 mt-1">
            {{ $tr('ارفع ملف Excel يحتوي على بيانات العقارات لاستيرادها دفعة واحدة', 'Upload an Excel file containing property data to import them in bulk') }}
        </p>
    </div>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6 mb-4">
        <div class="flex items-start gap-4">
            ...
            <div class="flex-1">
                ...
                <a href="{{ route('manager.properties.import.template') }}"
            ...
            <div class="flex-1">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-3 mb-3">
                    ...
                    <div class="bg-gray-50 border border-gray-100 rounded-lg p-3">
                        ...
                        <ul class="space-y-0.5 text-xs text-gray-500 columns-2">
                            ...
                            <li class="font-mono">bathrooms</li>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-2">
                    <div class="bg-indigo-50 rounded-lg p-2.5 text-xs">
                        ...
                        <p class="font-mono text-indigo-600 leading-relaxed">apartment_building<br>villa<br>farm<br>chalet</p>
                    </div>
                    <div class="bg-purple-50 rounded-lg p-2.5 text-xs">
                        ...
                        <br>
                        <p class="font-bold text-purple-700 mb-1 mt-1">section</p>
                        <p class="font-mono text-purple-600 leading-relaxed">hoa<br>management<br>external</p>
                    </div>
                    <div class="bg-amber-50 rounded-lg p-2.5 text-xs">
                        ...
                        <p class="font-mono text-amber-600 leading-relaxed">active<br>sold<br>under_maintenance<br>archived</p>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
        <div class="flex items-start gap-4">
            ...
            <div class="flex-1">
                ...
                <form method="POST" action="{{ route('manager.properties.import') }}"
