...
@endphp
<x-slot name="title">{{ $tr('استيراد عقارات خارجية من Excel', 'Import External Properties from Excel') }}</x-slot>
...
<div class="max-w-3xl mx-auto py-4">
    ...
    <div class="mb-6">
        <h2 class="text-xl font-bold text-gray-800">
            {{ $tr('استيراد عقارات خارجية من Excel', 'Import External Properties from Excel') }}
        </h2>
        <p class="text-sm text-gray-500 mt-1">
            {{ $tr('ارفع ملف Excel يحتوي على بيانات العقارات الخارجية لاستيرادها دفعة واحدة', 'Upload an Excel file containing external property data to import them in bulk') }}
        </p>
    </div>
    ...
    <div class="mb-6 space-y-3">
        ...
        <div class="flex items-start gap-3 bg-green-50 border border-green-200 rounded-xl px-4 py-3">
            ...
            <p class="text-green-800 text-sm font-medium">
                {{ $tr(
                    'تم استيراد ' . $results['imported'] . ' عقار بنجاح.',
                    $results['imported'] . ' ' . ($results['imported'] === 1 ? 'property' : 'properties') . ' imported successfully.'
                ) }}
            </p>
        </div>
        @else
        <div class="flex items-start gap-3 bg-yellow-50 border border-yellow-200 rounded-xl px-4 py-3">
            ...
            <p class="text-yellow-800 text-sm font-medium">
                {{ $tr('لم يتم استيراد أي عقار. راجع الأخطاء أدناه.', 'No properties were imported. Review the errors below.') }}
            </p>
        </div>
        @endif
        ...
        <div class="flex items-start gap-4">
            ...
            <div class="flex-1">
                ...
                <p class="text-xs text-gray-500 mb-3">
                    {{ $tr(
                        'حمّل ملف Excel القالب الذي يحتوي على أسماء الأعمدة الصحيحة. بيانات العقارات تبدأ من الصف الثاني.',
                        'Download the Excel template with the correct column headers. Row 1 is the header — enter your data from row 2 onwards.'
                    ) }}
                </p>
                <a href="{{ route('manager.external-properties.import.template') }}"
            ...
            <div class="flex-1">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-3 mb-3">
                    ...
                    <div class="bg-gray-50 border border-gray-100 rounded-lg p-3">
                        ...
                        <ul class="space-y-0.5 text-xs text-gray-500 columns-2">
                            ...
                            <li class="font-mono">address_en</li>
                            <li class="font-mono">city_ar / city_en</li>
                            <li class="font-mono">floors</li>
                            <li class="font-mono">total_area</li>
                            <li class="font-mono">bedrooms / bathrooms</li>
                            <li class="font-mono">status</li>
                            <li class="font-mono">rent_commission_rate</li>
                            <li class="font-mono">sale_commission_rate</li>
                            <li class="font-mono">commission_payer</li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-2">
                    <div class="bg-indigo-50 rounded-lg p-2.5 text-xs">
                        <p class="font-bold text-indigo-700 mb-1">type</p>
                        <p class="font-mono text-indigo-600 leading-relaxed">apartment_building<br>villa · farm · chalet<br>flat · land</p>
                    </div>
                    <div class="bg-amber-50 rounded-lg p-2.5 text-xs">
                        <p class="font-bold text-amber-700 mb-1">purpose</p>
                        <p class="font-mono text-amber-600 leading-relaxed">rent · sale · both<br>exclusive_rent<br>exclusive_sale</p>
                    </div>
                    <div class="bg-purple-50 rounded-lg p-2.5 text-xs">
                        <p class="font-bold text-purple-700 mb-1">commission_payer <span class="font-normal">(optional)</span></p>
                        <p class="font-mono text-purple-600 leading-relaxed">owner · tenant<br>buyer · shared</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
        <div class="flex items-start gap-4">
            ...
            <div class="flex-1">
                ...
                <form method="POST" action="{{ route('manager.external-properties.import') }}"
