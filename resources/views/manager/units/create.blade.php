<x-app-layout>
    ...
    <div class="max-w-2xl mx-auto">
        ...
        <form method="POST" action="{{ route('manager.units.store', $property) }}" class="bg-white rounded-xl shadow-sm border border-gray-100 p-6 space-y-4">
            @csrf
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <select name="type" required class="w-full border border-gray-200 rounded-lg px-3 py-2 text-sm">
                        ...
                        <option value="shop" @selected(old('type')==='shop')>محل تجاري</option>
