    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6 mb-4">
        <div class="flex items-start gap-4">
            ...
            <div class="flex-1">
                ...
                <a href="{{ route('manager.owner-leads.import.template') }}"
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
        <div class="flex items-start gap-4">
            ...
            <div class="flex-1">
                ...
                @endif
                <form method="POST" action="{{ route('manager.owner-leads.import') }}" enctype="multipart/form-data"
                      x-data="{ fileName: '' }">
                    @csrf
                    ...
                    <div class="flex gap-3 mt-4">
                        ...
                        <a href="{{ route('manager.owner-leads.index') }}" class="bg-gray-100 hover:bg-gray-200 text-gray-700 px-5 py-2 rounded-lg text-sm transition">{{ $tr('إلغاء', 'Cancel') }}</a>
                    </div>
                </form>
            </div>
        </div>
